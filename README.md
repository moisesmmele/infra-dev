...
3.  **DNS Configuration**: Creates a primary zone in Technitium DNS matching the `DNS_ZONE` variable.
4.  **Proxy Configuration**: Reads environment variables (e.g., `PORTAINER_CONTAINER_NAME`) to automatically create Proxy Hosts in Nginx Proxy Manager (NPM).
